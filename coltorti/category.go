...
func GetNaverCategoryCode(category string) string {
	categoryMappers := map[string]string{
		...
		"Women > Bags > Handbags":                                                       "50000640",
		"Women > Bags > Tote bags > Handbags":                                           "50000640",
		"Women > Bags > Handbags > Mini Bags":                                           "50000640",
		"Women > Bags > Cross Body & Shoulder Bags":                                     "50000639",
		"Women > Bags > Clutches > Cross Body & Shoulder Bags":                          "50000639",
